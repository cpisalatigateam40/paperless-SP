...
class ReportTofuVerifController extends Controller
{
    ...
    {
        return ReportTofuVerif::class;
    }

    protected function getBulkExportView(): string
    {
        return 'report_tofu_verifs.export';
    }

    protected function getBulkExportEagerLoad(): array
    {
        return ['productInfos', 'weightVerifs', 'defectVerifs'];
    }
    ...
    public function exportPdf($uuid)
    {
        ...
        $formNumber = \App\Models\FormNumber::get($report->area->uuid, 'report_tofu_verifs');
