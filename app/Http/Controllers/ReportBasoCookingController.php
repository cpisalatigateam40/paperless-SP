...
class ReportBasoCookingController extends Controller
{
    ...
    {
        return ReportBasoCooking::class;
    }

    protected function getBulkExportView(): string
    {
        return 'report_baso_cookings.export_pdf';
    }

    protected function getBulkExportEagerLoad(): array
    {
        return ['product', 'details.temperatures'];
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        $reports = ReportBasoCooking::with([
                'product',
                'details.temperatures',
            ])
        ...
        $filename = 'Baso_Cooking_'
            . $dateFrom->format('Ymd') . '_'
            . $dateTo->format('Ymd') . '.xlsx';
    
        return Excel::download(new BasoCookingExport($reports, $periodLabel), $filename);
    }
}