...
class ReportProductionNonconformityController extends Controller
{
    ...
    {
        return ReportProductionNonconformity::class;
    }

    protected function getBulkExportView(): string
    {
        return 'report_production_nonconformities.pdf';
    }
...
public function index(Request $request)
{
    ...
    public function exportExcel(Request $request)
    {
        ...
        $filename = 'Nonconformity_'
            . $dateFrom->format('Ymd') . '_'
            . $dateTo->format('Ymd') . '.xlsx';
    
        return Excel::download(new ProductionNonconformityExport($reports, $periodLabel), $filename);
    }
}