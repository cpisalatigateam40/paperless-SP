...
class ReportEmulsionMakingController extends Controller
{
    ...
    {
        return 'report_emulsion_makings.pdf';
    }

    protected function getBulkExportEagerLoad(): array
    {
        return ['header.agings', 'header.details.rawMaterial'];
    }
    ...
    {
        return 'laporan_emulsion_making';
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        $filename = 'Emulsion_Making_'
            . $dateFrom->format('Ymd') . '_'
            . $dateTo->format('Ymd') . '.xlsx';
    
        return Excel::download(new EmulsionMakingExport($reports, $periodLabel), $filename);
    }
