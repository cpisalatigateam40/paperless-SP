...
class ReportPackagingVerifController extends Controller
{
    ...
    {
        return ReportPackagingVerif::class;
    }

    protected function getBulkExportView(): string
    {
        return 'report_packaging_verifs.pdf';
    }

    protected function getBulkExportEagerLoad(): array
    {
        return ['details.checklist', 'details.product'];
    }
    ...
    {
        return 'laporan_packaging_verif';
    }
    ...
    public function exportPdf($uuid)
    {
        ...
        $formNumber = \App\Models\FormNumber::get($report->area->uuid, 'report_packaging_verifs');
