...
class ReportChangeoverCleaningController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'batches.*.machine_items.*.score.*'        => 'integer|min:1|max:8',
            ...
            'batches.*.sisa_bahan_items.*.score.*'     => 'integer|min:1|max:8',
            ...
            'batches.*.kondisi_ruangan_items.*.score.*'=> 'integer|min:1|max:8',
