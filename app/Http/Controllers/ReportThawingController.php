...
class ReportThawingController extends Controller
{
    ...
    public function exportPdf($uuid)
    {
       ...
       // Generate QR untuk created_by
        ...
        $formNumber = \App\Models\FormNumber::get($report->area->uuid, 'report_thawings');
