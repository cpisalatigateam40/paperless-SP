...
class ReportLabSampleController extends Controller
{
    ...
    {
        return ReportLabSample::class;
    }

    protected function getBulkExportView(): string
    {
        return 'report_lab_samples.export_pdf';
    }

    protected function getBulkExportEagerLoad(): array
    {
        return ['details.product', 'area'];
    }
    ...
    public function exportPdf($uuid)
    {
        ...
        $formNumber = \App\Models\FormNumber::get($report->area->uuid, 'report_lab_samples');
