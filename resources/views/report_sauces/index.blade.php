    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2" style="gap: .4rem;">
                ...
                <form method="GET" action="{{ route('report_sauces.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('report_sauces.index') }}"
                    ...
                    @if(request('search') || request('section'))
                        <a href="{{ route('report_sauces.index') }}"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-sauces.bulk-known"
                    count-route="report-sauces.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-sauces.bulk-approve"
                    count-route="report-sauces.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="gap: .3rem;">
                                ...
                                <!-- @can('edit report')
                                <a href="{{ route('report_sauces.edit', $r->uuid) }}" class="btn btn-sm btn-warning"
                                    title="Edit Laporan">
                                ...
                                @if($canEdit)
                                    <a href="{{ route('report_sauces.edit', $r->uuid) }}"
