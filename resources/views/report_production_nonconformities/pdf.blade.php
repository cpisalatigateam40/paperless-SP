...
<head>
    <meta charset="utf-8">
    <title>Laporan Ketidaksesuaian Proses Produksi</title>
    <style>
    body {
...
<body>
    ...
    <h3 class="mb-4 text-center" style="text-transform: uppercase;">Laporan Ketidaksesuaian Proses Produksi</h3>
