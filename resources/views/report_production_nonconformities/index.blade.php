...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-header d-flex justify-content-between">
            <h5>Laporan Ketidaksesuaian Proses Produksi</h5>
            
            <div class="d-flex gap-2" style="gap: .4rem;">

            @hasanyrole('admin|superadmin')
                <form method="GET" action="{{ route('report_production_nonconformities.index') }}">
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-production-nonconformities.bulk-known"
                    count-route="report-production-nonconformities.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-production-nonconformities.bulk-approve"
                    count-route="report-production-nonconformities.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
