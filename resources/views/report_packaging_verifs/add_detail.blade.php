    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('report_packaging_verifs.store-detail', $report->uuid) }}">
                ...
                {{-- === Checklist sama seperti di create === --}}
                @php
                $checklistGroups = [
                ...
                <div class="card mb-3">
                    <div class="card-header p-2"><strong>{{ $label }}</strong></div>
...
<div class="card mb-3">
    <div class="card-body p-2">
        <div class="row">
            <div class="col-md-3">
                <label><input type="checkbox" name="details[0][qc_verif]" value="1"> Verifikasi QC</label>
            </div>
            <div class="col-md-3">
                <label><input type="checkbox" name="details[0][kr_verif]" value="1"> Verifikasi KR</label>
            </div>
        </div>
    </div>
</div>
