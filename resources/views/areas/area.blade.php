                        ...
                        @foreach($areas as $index => $area)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('areas.destroy', $area->uuid) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger btn-sm" onclick="return confirm('Hapus area ini?')">Hapus</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
