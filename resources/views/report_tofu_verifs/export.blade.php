...
<head>
    <meta charset="utf-8">
    <title>Verifikasi Hasil Produksi Tofu</title>
    <style>
    @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center">VERIFIKASI HASIL PRODUKSI TOFU</h3>
    ...
    <table class="table table-bordered table-sm text-center align-middle">
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="5" style="text-align: right; border: none;">{{ $formNumber ?? '-' }}</td>
            </tr>
        </tbody>
    </table>
