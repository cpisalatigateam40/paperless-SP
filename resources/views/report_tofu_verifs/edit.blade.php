...
<div class="container-fluid">
    <x-breadcrumb :items="[
        ['label' => 'Verifikasi Hasil Produksi Tofu', 'url' => route('report_tofu_verifs.index')],
    ...
    <form action="{{ route('report_tofu_verifs.update', $report->uuid) }}" method="POST">
        ...
        <div class="accordion-body card shadow">
            ...
            <div class="row mb-2 card-body">
                ...
                <div class="col-md-4">
                    <label>{{ $label }} - %</label>
                    <input type="number" step="0.01" name="products[{{ $i }}][weight_verifs][{{ $key }}][percentage]"
            ...
            <div class="row mb-2 card-body">
                ...
                <div class="col-md-4">
                    <label>{{ $label }} - %</label>
                    <input type="number" step="0.01" name="products[{{ $i }}][defect_verifs][{{ $key }}][percentage]"
