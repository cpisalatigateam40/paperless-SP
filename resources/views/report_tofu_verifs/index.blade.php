...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Verifikasi Hasil Produksi Tofu</h5>
            ...
            <div class="d-flex gap-2" style="gap: .4rem;">
                ...
                <form method="GET"
                    ...
                    @if(request('search') || request('section'))
                        <a href="{{ route('report_tofu_verifs.index') }}"
                ...
                <x-export-pdf-modal
                    :route="route('report_tofu_verifs.export_pdf_bulk')"
                    title="Verifikasi Produk Tofu"
                    modal-id="modalExportPdfTofuVerif"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-tofu-verifs.bulk-known"
                    count-route="report-tofu-verifs.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-tofu-verifs.bulk-approve"
                    count-route="report-tofu-verifs.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
