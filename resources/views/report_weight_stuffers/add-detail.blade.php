    ...
    <form action="{{ route('report_weight_stuffers.store-detail', $report->uuid) }}" method="POST" id="addDetailForm" enctype="multipart/form-data">
        ...
        <div class="card shadow mb-4">
            <div class="card-header fw-bold">
                Tambah Detail — Laporan {{ $report->date }} Shift {{ $report->shift }}
            </div>
...
// ---------------------------------------------------------------
document.getElementById('addDetailForm').addEventListener('input', function (e) {
...
// ---------------------------------------------------------------
document.getElementById('addDetailForm').addEventListener('submit', async function (e) {
    e.preventDefault();
