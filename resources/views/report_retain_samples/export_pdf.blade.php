...
<head>
    <title>Pendataan Retain Sample</title>
    <style>
    @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center">PENDATAAN RETAIN SAMPLE ABF/IQF</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            @endforelse
            <tr>
                <td colspan="10" style="text-align: right; border: none;">QM 04 / 01</td>
            </tr>
        </tbody>
    </table>
