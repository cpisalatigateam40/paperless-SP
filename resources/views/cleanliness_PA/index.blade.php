...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>Verifikasi Kesesuaian Area Proses Produksi</h5>
            
            <div class="d-flex gap-2" style="gap: .4rem;">
                @hasanyrole('admin|superadmin')
                <form method="GET" action="{{ route('process-area-cleanliness.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('process-area-cleanliness.index') }}"
                    ...
                    @if(request('search') || request('section'))
                        <a href="{{ route('process-area-cleanliness.index') }}"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="process-area-cleanliness.bulk-known"
                    count-route="process-area-cleanliness.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="process-area-cleanliness.bulk-approve"
                    count-route="process-area-cleanliness.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
