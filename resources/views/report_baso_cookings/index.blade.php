    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2" style="gap: .4rem;">
                ...
                <form method="GET" action="{{ route('report_baso_cookings.index') }}">
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-baso-cookings.bulk-known"
                    count-route="report-baso-cookings.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-baso-cookings.bulk-approve"
                    count-route="report-baso-cookings.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
