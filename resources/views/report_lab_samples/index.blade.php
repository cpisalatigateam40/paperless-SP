...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-header d-flex justify-content-between">
            <h5>Form Pengambilan Sample</h5>
            
            <div class="d-flex gap-2" style="gap: .4rem;">

                @hasanyrole('admin|superadmin')
                <form method="GET" action="{{ route('report_lab_samples.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('report_lab_samples.index') }}"
                    ...
                    @if(request('search') || request('section'))
                        <a href="{{ route('report_lab_samples.index') }}"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-lab-samples.bulk-known"
                    count-route="report-lab-samples.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-lab-samples.bulk-approve"
                    count-route="report-lab-samples.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
