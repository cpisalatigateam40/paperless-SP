...
<head>
    <title>Verifikasi Proses Pembuatan Kulit Siomay/Gyoza</title>
    <style>
    @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center" style="text-transform: uppercase;">Verifikasi Proses Pembuatan Kulit Siomay/Gyoza</h3>
