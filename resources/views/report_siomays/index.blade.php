    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2" style="gap: .4rem;">
                ...
                <form method="GET" action="{{ route('report_siomays.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('report_siomays.index') }}"
                    ...
                    @if(request('search') || request('section'))
                        <a href="{{ route('report_siomays.index') }}"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-siomays.bulk-known"
                    count-route="report-siomays.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-siomays.bulk-approve"
                    count-route="report-siomays.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
