...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header">
            <h5>Edit Verifikasi Alat Ukur</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('report-scales.update-next', $report->uuid) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="tab-content mt-3">
                    ...
                    <div class="tab-pane fade show active" id="scale">
                        @include('report_scales.partials.editnext_scale', [
                    ...
                    <div class="tab-pane fade" id="thermometer">
                        @include('report_scales.partials.editnext_thermometer', [
