...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>Verifikasi Alat Ukur</h5>
            
            <div class="d-flex gap-2" style="gap: .4rem;">

            @hasanyrole('admin|superadmin')
                <form method="GET" action="{{ route('report-scales.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('report-scales.index') }}"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-scales.bulk-known"
                    count-route="report-scales.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-scales.bulk-approve"
                    count-route="report-scales.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
