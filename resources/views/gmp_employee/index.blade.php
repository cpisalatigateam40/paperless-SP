                            ...
                            <td colspan="6">
                                ...
                                <table class="table table-bordered table-sm mt-2">
                                    <thead class="text-center align-middle">
                                        ...
                                        <tr>
                                            <th colspan="2">Jam 1: <span style="font-weight: 400">{{ $hour1 }}</span>
                                            </th>
                                            <th colspan="2">Jam 2: <span style="font-weight: 400">{{ $hour2 }}</span>
                                            </th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table-secondary text-center align-middle">
                                            <td></td> {{-- kosongkan no --}}
                                            <td colspan="6" class="text-start">↳ Koreksi Lanjutan #{{ $index + 1 }}</td>
