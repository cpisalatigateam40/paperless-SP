    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2" style="gap: .4rem;">
                ...
                <form method="GET" action="{{ route('gmp-employee.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('gmp-employee.index') }}"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="gmp-employee.bulk-known"
                    count-route="gmp-employee.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="gmp-employee.bulk-approve"
                    count-route="gmp-employee.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
