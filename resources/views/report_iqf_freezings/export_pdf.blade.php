...
<head>
    <meta charset="utf-8">
    <title>Report Verifikasi Pembekuan IQF</title>
    <style>
    @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center">Report Verifikasi Pembekuan IQF</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="2">Suhu Produk Sebelum IQF (°C)</th>
                <th colspan="2">Pembekuan IQF</th>
                <th colspan="2">Suhu IQF (°C)</th>
            </tr>
            <tr>
                <th>Jam Mulai Pembekuan</th>
                <th>Lama Pembekuan (menit)</th>
                <th>Room</th>
                <th>Suction</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td>{{ $i + 1 }}</td>
                <td class="text-left">{{ optional($detail->product)->product_name ?? '-' }}</td>
            ...
            @empty
            <tr>
                <td colspan="9">Belum ada detail produk</td>
            </tr>
            @endforelse
            <tr>
                <td colspan="9" style="text-align: right; border: none;">QM 33 / 00</td>
            </tr>
        </tbody>
    </table>
