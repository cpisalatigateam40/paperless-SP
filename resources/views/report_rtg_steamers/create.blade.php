...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('report_rtg_steamers.store') }}" method="POST" id="steamers-form"
                ...
                <!-- <button type="button" class="btn btn-success btn-sm mb-3" onclick="addDetail()">+ Tambah Detail
                    Steamer</button> -->
