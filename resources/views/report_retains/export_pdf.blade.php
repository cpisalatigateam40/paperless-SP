...
<body>
    ...
    <h3 class="mb-2 text-center">RETAINED SAMPLE REPORT</h3>
            ...
            <td style="width: 60%; border: none;">
                <table style="width: 100%; border: none;">
                    ...
                    <tr>
                        ...
                        <td style="border: none;">: {{ $report->section->section_name ?? '-' }}</td>
                    </tr>
                    <tr>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="6" style="text-align: right; border: none;">QM 28 / 00</td>
            </tr>
        </tbody>
    </table>
