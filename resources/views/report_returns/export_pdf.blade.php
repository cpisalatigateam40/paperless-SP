...
<body>
    ...
    <h3 class="mb-2 text-center">RETUR KETIDAKSESUAIAN BAHAN BAKU / BAHAN KEMAS</h3>
    ...
    <table style="width: 100%; border: none; margin-bottom: 1rem; font-size: 10px;">
        <tr>
            <td style="width: 45%; border: none;">NAMA BAHAN BAKU / BAHAN KEMAS (**)</td>
        ...
        <tr>
            <td style="border: none;">SUPPLIER / KODE SUPPLIER</td>
        ...
        <tr>
            <td style="border: none;">KODE PRODUKSI / IDENTITAS</td>
            <td style="border: none;">:</td>
            <td style="border: none; border-bottom:1px solid #000;">
        ...
        <tr>
            <td style="border: none;">ALASAN HOLD</td>
            <td style="border: none;">:</td>
            <td style="border: none; border-bottom:1px solid #000;">
                {{ $detail->hold_reason }}
            </td>
        ...
        <tr>
            <td style="border: none;">JUMLAH (KG/PCS/BAG/KARUNG/BOX)</td>
            <td style="border: none;">:</td>
            <td style="border: none; border-bottom:1px solid #000;">
        ...
        <tr>
            <td colspan="3" style="text-align: right; border: none;">QM 42 / 00</td>
        </tr>
    </table>
    @endforeach
