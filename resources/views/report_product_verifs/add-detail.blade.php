...
<div class="container-fluid">
    <form action="{{ route('report_product_verifs.store-detail', $report->uuid) }}" method="POST">
        @csrf

        <div class="alert alert-info">
            <strong>Laporan:</strong> Tanggal {{ $report->date }} — Shift {{ $report->shift }}
        </div>
...
document.getElementById('add-detail').addEventListener('click', function() {
    ...
    const newHtml = newTbody.innerHTML
        ...
        .replaceAll(/onchange="updateExpiredDate\(this, 0\)"/g,
