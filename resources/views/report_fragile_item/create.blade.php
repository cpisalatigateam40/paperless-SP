                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div style="margin-right: 1rem; display: flex; gap: 3.5rem;">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label for="checkAllStart-{{ Str::slug($section) }}" class="form-check-label">Check All Awal</label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline" >
                                                ...
                                                <label for="checkAllEnd-{{ Str::slug($section) }}" class="form-check-label">Check All Akhir</label>
                                            </div>
