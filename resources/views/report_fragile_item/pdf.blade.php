...
<head>
    <meta charset="utf-8">
    <title>Pemeriksaan Barang Mudah Pecah (Glass & Brittle Plastic)</title>
    <style>
    body {
...
<body>
    ...
    <h3 class="mb-2 text-center" style="text-transform: uppercase;">Pemeriksaan Barang Mudah Pecah (Glass & Brittle Plastic)</h3>
