    ...
    <div class="card shadow">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <form method="GET" action="{{ route('report-fragile-item.index') }}">
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-fragile-item.bulk-known"
                    count-route="report-fragile-item.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-fragile-item.bulk-approve"
                    count-route="report-fragile-item.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
