...
<head>
    <title>Verifikasi Proses Pasteurisasi Produk di Retort Chamber</title>
    <style>
    @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center" style="text-transform: uppercase;">Verifikasi Proses Pasteurisasi Produk di Retort Chamber</h3>
