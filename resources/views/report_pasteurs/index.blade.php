...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>Verifikasi Proses Pasteurisasi Produk di Retort Chamber</h5>
            
            <div class="d-flex gap-2" style="gap: .4rem;">
                @hasanyrole('admin|superadmin')
                <form method="GET" action="{{ route('report_pasteurs.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('report_pasteurs.index') }}"
                    ...
                    @if(request('search') || request('section'))
                        <a href="{{ route('report_pasteurs.index') }}"
