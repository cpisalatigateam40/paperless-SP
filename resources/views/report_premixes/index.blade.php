...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-header d-flex justify-content-between">
            <h5>Laporan Verifikasi Premix</h5>
            
            <div class="d-flex gap-2" style="gap: .4rem;">
                @hasanyrole('admin|superadmin')
                <form method="GET" action="{{ route('report-premixes.index') }}">
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-premixes.bulk-known"
                    count-route="report-premixes.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-premixes.bulk-approve"
                    count-route="report-premixes.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole
