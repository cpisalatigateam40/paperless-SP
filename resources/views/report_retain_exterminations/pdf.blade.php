...
<head>
    <meta charset="utf-8">
    <title>Report Pemusnahan Retain Sample</title>
    <style>
    body {
...
<body>
    ...
    <h3 class="mb-4 text-center">PEMUSNAHAN RETAIN SAMPLE</h3>
    ...
    <table>
        <thead>
            <tr>
                <th rowspan="2">No</th>
                <th rowspan="2">Nama Retain</th>
                <th rowspan="2">Exp Date</th>
                <th colspan="2">Jumlah</th>
                <th rowspan="2">Kondisi Retain</th>
                <th rowspan="2">Keterangan</th>
            </tr>
            <tr>
                <th>Box / Karung / Plastik</th>
                <th>Kg</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($detail->exp_date)->format('d-m-Y') }}</td>
                <td>{{ $detail->quantity }} {{ $detail->shape }}</td>
                <td>{{ $detail->quantity_kg }}</td>
                <td>{{ $detail->retain_condition }}</td>
                <td>{{ $detail->notes }}</td>
            </tr>
            @endforeach
            <tr>
                <td colspan="7" style="text-align: right; border: none;">QM 43 / 00</td>
            </tr>
        </tbody>
    </table>
    ...
    <table style="width: 100%; border: none; margin-top: 4rem;">
        <tr style="border: none;">
            ...
            <td style="text-align: center; border: none; width: 25%;">
                Diterima dan Dimusnahkan Oleh,<br><br>
                <div style="height: 50px;"></div>
