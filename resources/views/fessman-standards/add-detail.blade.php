...
<div class="container">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('fessman-standards.store') }}" method="POST">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <label>Time (min) Min</label>
                        <input type="number" name="steps[0][time_minute_min]" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label>Time (min) Max</label>
                        <input type="number" name="steps[0][time_minute_max]" class="form-control">
                    </div>
                </div>
