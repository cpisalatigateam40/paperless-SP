...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-header">
            <h4>Tambah Report Vacuum Condition + Detail</h4>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('report_vacuum_conditions.store') }}">
                @csrf
...
function updateExpiredDate(select, index) {
    ...
    if (shelfLife && createdAt) {
        ...
        let month = String(createdDate.getMonth() + 1).padStart(2, '0'); // Month is 0-indexed
