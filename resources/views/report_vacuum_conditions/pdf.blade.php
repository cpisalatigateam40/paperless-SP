...
<head>
    <meta charset="utf-8">
    <title>Report Vacuum Condition</title>
    <style>
        @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center">VERIFIKASI KONDISI VAKUM PRODUK SETELAH IQF</h3>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="3">Expired date</th>
                <th colspan="5">Loss Vacuum Setelah IQF</th>
            </tr>
            <tr>
                <th rowspan="2">Jumlah (pack)</th>
                <th colspan="4">Area bocor (√)</th>
            </tr>
            <tr>
                <th>Seal</th>
                <th>Melipat</th>
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="9" style="text-align: right; border: none;">QM 36 / 00</td>
            </tr>
        </tbody>
    </table>
