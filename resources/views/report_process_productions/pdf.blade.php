...
<head>
    <meta charset="utf-8">
    <title>Verifikasi Proses Mixing, Chopping, dan Emulsifying</title>
    <style>
    @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center" style="text-transform: uppercase;">Verifikasi Proses Mixing, Chopping, dan Emulsifying</h3>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="5">{{ $detail->rework_kg ?? '-' }} / {{ $detail->rework_percent ?? '-' }}</td>
        </tr>
        <tr>
