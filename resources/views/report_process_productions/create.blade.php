                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" name="homogeneous" value="OK"
                                class="form-check-input" id="homogeneous_ok" checked>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" name="stiffness" value="OK"
                                class="form-check-input" id="stiffness_ok" checked>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" name="aroma" value="OK"
                                class="form-check-input" id="aroma_ok" checked>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" name="foreign_object" value="Tidak Terdeteksi"
                                class="form-check-input" id="foreign_object_ok" checked>
