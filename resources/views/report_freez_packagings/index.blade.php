    ...
    <div class="card shadow">
        <div class="card-header d-flex justify-content-between">
            ...
            @hasanyrole('admin|superadmin')
                <form method="GET" action="{{ route('report_freez_packagings.index') }}">
                ...
                {{-- 🔍 SEARCH --}}
                <form method="GET"
                    action="{{ route('report_freez_packagings.index') }}"
                    ...
                    @if(request('search') || request('section'))
                        <a href="{{ route('report_freez_packagings.index') }}"
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-freez-packagings.bulk-known"
                    count-route="report-freez-packagings.bulk-known-count"
                    label="Approve Semua"
                />
                @endrole
                ...
                <x-bulk-approval-modal
                    ...
                    action-route="report-freez-packagings.bulk-approve"
                    count-route="report-freez-packagings.bulk-approve-count"
                    label="Approve Semua"
                />
                @endrole

                <x-export-excel-modal 
                    :route="route('report_freez_packagings.export')" 
                    title="Verifikasi Pembekuan IQF & Pengemasan Karton Box" />
