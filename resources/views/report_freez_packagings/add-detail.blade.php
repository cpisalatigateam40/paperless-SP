...
<div class="container-fluid">
    <div class="card shadow">
        <div class="card-header">
            <h4 class="mb-4">Tambah Detail Laporan - {{ $report->date }} / Shift {{ $report->shift }}</h4>
        </div>

        <div class="card-body">
            <form action="{{ route('report_freez_packagings.store-detail', $report->uuid) }}" method="POST">
                @csrf

                <h5 class="mt-3 mb-4">Detail Produk</h5>
...
<div class="card mb-4 p-3 border">
    ...
    <div class="row">
        <div class="col-md-4">
            <label>Kode Karton</label>
            <input type="text" name="details[${index}][kartoning][carton_code]" class="form-control">
        </div>
        <div class="col-md-4">
            <label>Isi Bag</label>
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-6">
            ...
            <input type="number" step="0.01" name="details[${index}][kartoning][carton_weight_actual]" class="form-control">
        </div>
    </div>
</div>
`;
