...
<head>
    <meta charset="utf-8">
    <title>Verifikasi Proses Pasteurisasi Produk di Waterbath</title>
    <style>
    @font-face {
...
<body>
    ...
    <h3 class="mb-2 text-center" style="text-transform: uppercase;">Verifikasi Proses Pasteurisasi Produk di Waterbath</h3>
