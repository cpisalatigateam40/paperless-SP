...
return new class extends Migration
{
    ...
    {
        Schema::create('pasteurisasi_waterbaths', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->uuid('report_uuid')->nullable();
            $table->decimal('initial_product_temp', 5, 2)->nullable();
            $table->decimal('initial_water_temp', 5, 2)->nullable();
            $table->time('start_time_pasteur')->nullable();
            $table->time('stop_time_pasteur')->nullable();
            $table->decimal('water_temp_after_input_panel', 5, 2)->nullable();
            $table->decimal('water_temp_after_input_actual', 5, 2)->nullable();
            $table->decimal('water_temp_setting', 5, 2)->nullable();
            $table->decimal('water_temp_actual', 5, 2)->nullable();
            $table->decimal('water_temp_final', 5, 2)->nullable();
    ...
    {
        Schema::dropIfExists('pasteurisasi_waterbaths');
    }
};