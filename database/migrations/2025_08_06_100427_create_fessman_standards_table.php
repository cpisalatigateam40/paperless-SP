...
return new class extends Migration
{
    ...
    {
        Schema::create('fessman_standards', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('time_minute_min')->nullable();
            $table->integer('time_minute_max')->nullable();
    ...
    {
        Schema::dropIfExists('fessman_standards');
    }
};