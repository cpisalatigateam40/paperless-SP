...
return new class extends Migration
{
    ...
    {
        Schema::create('pre_operation_materials', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid')->unique();
            $table->uuid('report_uuid')->nullable();
            $table->enum('type', ['raw_material', 'supporting_material'])->nullable();
    ...
    {
        Schema::dropIfExists('pre_operation_materials');
    }
};