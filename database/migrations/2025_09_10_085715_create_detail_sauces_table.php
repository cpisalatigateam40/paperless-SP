...
return new class extends Migration {
    ...
    {
        Schema::create('detail_sauces', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('report_uuid')->references('uuid')->on('report_sauces')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('detail_sauces');
    }
};