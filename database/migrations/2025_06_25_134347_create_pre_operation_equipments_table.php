...
return new class extends Migration
{
    ...
    {
        Schema::create('pre_operation_equipments', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('equipment_uuid')->references('uuid')->on('equipments')->onDelete('set null');
        });
    }
    ...
    {
        Schema::dropIfExists('pre_operation_equipments');
    }
};