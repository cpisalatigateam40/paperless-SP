...
return new class extends Migration
{
    ...
    {
        Schema::create('rm_siomays', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('detail_uuid')->references('uuid')->on('detail_siomays')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('rm_siomays');
    }
};